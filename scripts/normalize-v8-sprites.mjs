...
const groups = [
  { input: "v7-concrete-chassis.png", output: "v8-rig-chassis.png", maxW: 470, maxH: 230, x: "center", y: "bottom", bottom: 370 },
  { input: "v7-concrete-bodies.png", output: "v8-rig-bodies.png", maxW: 460, maxH: 340, x: "center", y: "bottom", bottom: 440 },
  { input: "v7-concrete-cabs.png", output: "v8-rig-cabs.png", maxW: 390, maxH: 445, x: "right", y: "bottom", right: 28, bottom: 482 },
  { input: "v7-concrete-tools.png", output: "v8-rig-tools.png", maxW: 466, maxH: 430, x: "left", y: "center", left: 23 },
  { input: "v7-concrete-movement.png", output: "v8-rig-movement.png", maxW: 440, maxH: 440, x: "center", y: "bottom", bottom: 486 },
];

for (const group of groups) {
  const inputPath = path.join(assets, group.input);
